...
import WovenWindImage4 from "../assets/projects/wovenwind4.jpg";
...
function Projects() {
  ...
  useEffect(() => {
    ...
    if (
      filterParam &&
      ["robotics", "hardware", "design"].includes(filterParam)
    ) {
  ...
  const projects = [
    {
      ...
      description:
        "Designed and tested a high-speed PCB for Neurobionics Lab at the University of Michigan",
    ...
    },
    {
      ...
      description:
        "Worked with U-M professor to develop a robot capable of navigating and adapting to crowded social environments",
      image: ShortbotImage,
    ...
    },
    {
      title: "LostandFound+",
      description:
        "A tool-tracking system to help makerspaces keep a record of shared tools and materials",
      ...
      motivation:
        "Improving and simplifying the lives of my coworkers, managers, and makerspace users by digitizing the tool check-out system",
      stage:
        "Working prototype and beta test complete, system currently being used in 2 makerspaces on campus",
      link: null,
      github: "#",
      color: "#00C6A7",
      gridSpan: "medium",
    ...
    },
    {
      title: "Woven Wind",
      description:
        "Bringing immersive renewable energy education to underserved elementary and middle schools",
      image: WovenWindImage,
      thumbnailImages: [WovenWindImage],
      video: WovenWindVideo,
      additionalImages: [WovenWindImage3, WovenWindImage4],
      imageDescriptions: {
        video: "Completed wind turbine",
        image2:
          "Team photo with the Woven Wind project at Pleasant Lake Elementary School",
        image3:
          "Activity day with the kids at PEACE Neighborhood Center where we learned about renewable energy",
      },
      tags: ["Project Management", "CAD", "Manufacturing"],
      category: "design",
      timeline: "January 2023 - May 2024",
      role: "President",
      motivation: "Spreading renewable energy education to under-resourced communities",
      stage:
        "Designing the final prototype of a wind turbine to be installed and integrated into Pleasant Lake Elementary School",
      link: "#",
      github: null,
      color: "#10B981",
      gridSpan: "medium", // 2x1
    ...
    },
    {
      title: "Ball-bot",
      description:
        "Wrote control code and manufactured a robot capable of balancing on a basketball, currently iterating on the design and teaching it to other students",
      thumbnailImages: [BallbotImage],
      video: BallbotVideo,
      imageDescriptions: {
        video:
          "Ball-bot balancing demonstration showing the robot successfully maintaining stability on a basketball",
      },
      ...
      stage:
        "Got 3rd place in the entire class for best control of our ball-bot. I have since helped develop the curriculum for the class as a Graduate Student Instructor by creating new labs and presenting on course content.",
      link: null,
      github: null,
      color: "#F97316",
      gridSpan: "medium", // 2x1
    ...
    },
    {
      title: "Safebites",
      description:
        "A restaurant safety rating system to bring business to restaurants during the COVID-19 pandemic",
      ...
      motivation:
        "Helping local restaurant owners stay in business after our family's restaurant was shut down due to the pandemic",
      stage: <p>
              Successfully beta tested with users and{" "}
              <a
                href="https://www.cnn.com/2020/09/27/us/teen-inventors-coronavirus-pandemic-trnd"
                target="_blank"
    ...
    },
    {
      ...
      description:
        "Leveraging makerspace tools to create a unique and useful product",
      image: BTSpeakerImage1,
      thumbnailImages: [BTSpeakerImage1],
      additionalImages: [BTSpeakerImage2, BTSpeakerImage3],
      imageDescriptions: {
        image2:
          "This was the first circuit board I ever created! I started out by prototyping the components on a breadboard. I then used my school's shop to mill my own board and solder all the components on.",
        image3:
          "I made the frame by planing my wood to thin it out, so it could be cut using the laser cutter. I then cut out each layer of the frame, glued them together, and sanded like a crazy person to remove all the burn marks. My arm was so sore by the end, but the final product made it worth the effort.",
      },
    ...
    },
    {
      ...
      description:
        "Created an automatic pin art board using solenoids and relays to activate pins",
      ...
      imageDescriptions: {
        video:
          "Working demonstration of the automated pin array activating to create dynamic patterns",
        image2:
          "Close-up view showing the solenoid and relay system that controls individual pins",
        image3:
          "Full front view of the completed pin art board with grid of programmable pins",
      },
    ...
    },
    {
      ...
      description:
        "Built an EMG circuit to measure the electric current produced when a muscle contracts and used it to drive a remote control car",
      image: EMGCarImage,
      thumbnailImages: [EMGCarImage],
      additionalImages: [EMGCarImage2, EMGCarImage3],
      imageDescriptions: {
        image2:
          "Close-up of the EMG circuit board showing the sensor connections and components",
        image3:
          "Testing the EMG-controlled car with muscle signals to successfully driving the robot!",
      },
      ...
      stage:
        "Successfully isolated the signal from muscle flexion, and drove a small robot!",
      link: null,
      github: null,
      color: "#3B82F6",
      gridSpan: "medium", // 2x1 - expanded for better image display
    ...
    },
    {
      title: "M-Plan",
      description:
        "A scheduling tool for college students to plan ahead their classes and credits",
      image: MPlanImage,
      ...
      motivation:
        "Creating a platform to help friends and myself plan out classes ahead of time",
      stage:
        "Semi-functional prototype for personal use, planning to expand functionality in the winter",
      link: null,
      github: null,
      color: "#FFCB05",
      gridSpan: "medium", // 2x1
        ...
        <section className="section">
          <div className="container">
            ...
            >
              <SectionTitle
                title="My Projects"
                subtitle="I most enjoy building projects for the communities I care about. Here’s a snapshot of devices and software tools I’ve taken from idea to prototype...and sometimes all the way to deployment! Click any card to explore the details."
              />
            </motion.div>
                    ...
                    >
                      ...
                      <CaseSection
                        ...
                        image={
                          ...
                          >
                            <img
                              src={LostFoundCurrentSystem}
                              alt="Current paper system"
                              style={{
                                width: "100%",
                      ...
                      >
                        ...
                        >
                          I conducted multiple user studies with my primary and
                          tertiary stakeholders to gather insights and feedback
                          as to what the site should look like
                        </p>
                      </div>
                        ...
                        quote={
                          <div>
                            ...
                            >
                              ...
                              >
                                Communal items don't come back, are returned
                                broken, or just cannot be found
                              </p>
                            </div>
                            <div
                              style={{
                            ...
                            >
                              ...
                              >
                                It's 2024 and the University is still using
                                paper systems
                              </p>
                            </div>
                            <div
                            ...
                            >
                              ...
                              >
                                I need a system to hold students accountable for
                                returning tools
                              </p>
                            </div>
                          </div>
                      ...
                      >
                        ...
                        >
                          ...
                          <div>
                            ...
                            >
                              ...most of our drawers in the makerspace look like
                              this:
                            </p>
                          </div>
                        </div>
                      ...
                      <div
                        style={{
                          background:
                            "linear-gradient(135deg, #F2FBFA 100%, #F2FBFA 100%)",
                      ...
                      >
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p style={{ color: "var(--text-secondary)" }}>
                              Staff can track all items in use or missing
                              through a personal dashboard with real-time
                              updates.
                            </p>
                      ...
                      >
                        ...
                        >
                          We ran the experiment for a select few tools in the
                          makerspace over the duration of 2 weeks and gathered
                          user feedback.
                        </p>
                      ...
                      >
                        ...
                        >
                          Some core feedback received was to make it easier for
                          admin to edit and track tools. In response, V2
                          includes a "Tickets" page with a complete history of
                          all checked out tools, as well as features in the
                          inventory section allowing staff to easily edit
                          existing tools.
                        </p>
                        <div
                          style={{
                        ...
                        >
                          LostFound+ is now deployed in 2 makerspaces on campus
                          with regular communication and improvements being made
                          as it gets more use!
                        </p>
                      </div>
                    </CaseStudyCard>
